...
* The original package name 'com.demo.spring-ai' is invalid and this project uses 'com.demo.spring_ai' instead.
...
```
$ docker run --rm -p 8080:8080 spring-ai:0.0.1-SNAPSHOT
```
